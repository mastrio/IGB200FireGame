...
2. Clone the repo
   ```sh
   git clone https://github.com/mastrio/IGB200FireGame.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin mastrio/IGB200FireGame
...
<a href="https://github.com/mastrio/IGB200FireGame/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=mastrio/IGB200FireGame" alt="contrib.rocks image" />
</a>
...
Project Link: [https://github.com/mastrio/IGB200FireGame](https://github.com/mastrio/IGB200FireGame)
